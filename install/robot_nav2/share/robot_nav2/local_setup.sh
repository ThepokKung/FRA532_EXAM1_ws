...
: ${AMENT_CURRENT_PREFIX:="/home/kraiwich/FRA532_EXAM1_ws/install/robot_nav2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_nav2/environment/pythonpath.sh"
